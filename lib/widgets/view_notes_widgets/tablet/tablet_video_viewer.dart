...
class TabletVideoViewer extends StatefulWidget {
  ...
  @override
  State<TabletVideoViewer> createState() => _TabletVideoViewerState();
}

class _TabletVideoViewerState extends State<TabletVideoViewer> {
                                ...
                                IconButton(
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => TabletVideoViewer(
